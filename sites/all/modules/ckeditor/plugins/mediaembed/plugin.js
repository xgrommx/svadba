...
( function () {
  CKEDITOR.plugins.add('mediaembed', {
      ...
      init:function (editor) {
        editor.addCss('img.cke_mediaembed' + '{' + 'background-image: url(' + CKEDITOR.getUrl(this.path + 'images/placeholder.gif') + ');' + 'background-position: center center;' + 'background-repeat: no-repeat;' + 'border: 1px solid #a9a9a9;' + 'width: 80px;' + 'height: 80px;' + '}');
        var me = this;
                ...
                'div':function (element) {
                  ...
                  if (element.attributes[ 'class' ] == 'media_embed') {
                    ...
                    if (typeof(element.children[0].attributes) != 'undefined') {
                      var height = element.children[0].attributes.height, width = element.children[0].attributes.width;
                    }
