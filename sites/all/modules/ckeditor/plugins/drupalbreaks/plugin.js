  ...
  CKEDITOR.plugins.add('drupalbreaks', {
      ...
      init:function (editor) {
        ...
        function insertComment(text) {
          ...
          var range = editor.getSelection().getRanges()[0], elementsPath = new CKEDITOR.dom.elementPath(range.getCommonAncestor(true)), element = ( elementsPath.block && elementsPath.block.getParent() ) || elementsPath.blockLimit, hasMoved;
