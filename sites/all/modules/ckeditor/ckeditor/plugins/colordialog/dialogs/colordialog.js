...
CKEDITOR.dialog.add('colordialog', function (a) {
  ...
  ;
  function i(z) {
    if (!(z instanceof CKEDITOR.dom.event)) {
      z = new CKEDITOR.dom.event(z);
    }
    var A = z.getTarget(), B;
    if (A.getName() == 'a' && (B = A.getChild(0).getHtml())) {
      f.getContentElement('picker', 'selectedColor').setValue(B);
    }
  }
