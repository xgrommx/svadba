    ...
    var p = function (C, D) {
      ...
      if (D == 'check') {
        if (!C.userlockRatio && E.getCustomData('isReady') == 'true') {
          var F = C.getValueOf('info', 'txtWidth'), G = C.getValueOf('info',
            'txtHeight'), H = E.$.width * 1000 / E.$.height, I = F * 1000 / G;
          C.lockRatio = false;
          if (!F && !G) {
            C.lockRatio = true;
          }
    ...
    return{title:b.lang.image[c == 'image' ? 'title' : 'titleButton'], minWidth:420, minHeight:360, onShow:function () {
        ...
        if (G.count() == 1) {
          ...
          if (H == 'img' || H == 'input') {
            ...
            if (I.imageElement.getName() == 'img') {
              ...
              if (I.imageElement.getName() == 'input') {
      ...
      if (D.imageEditMode) {
        ...
        if (c == 'image' && C == 'input' && confirm(b.lang.image.button2Img)) {
          ...
          if (c != 'image' && C == 'img' && confirm(b.lang.image.img2Button)) {
            C = 'input';
      ...
      {id:'advanced', label:b.lang.common.advancedTab, elements:[
        ...
        {type:'text', id:'txtdlgGenStyle', label:b.lang.common.cssStyle, validate:CKEDITOR.dialog.validate.inlineStyle(b.lang.common.invalidInlineStyle), 'default':'', setup:function (C, D) {
          if (C == d) {
