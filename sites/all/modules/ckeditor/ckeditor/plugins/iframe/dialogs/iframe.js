  ...
  CKEDITOR.dialog.add('iframe', function (d) {
    ...
    return{title:e.title, minWidth:350, minHeight:260, onShow:function () {
      ...
      {id:'info', label:f.generalTab, accessKey:'I', elements:[
        ...
        {type:'hbox', children:[
          {id:'width', type:'text', style:'width:100%', labelLayout:'vertical', label:f.width, validate:CKEDITOR.dialog.validate.htmlLength(f.invalidHtmlLength.replace('%1',
            f.width)), setup:b, commit:c},
          {id:'height', type:'text', style:'width:100%', labelLayout:'vertical', label:f.height, validate:CKEDITOR.dialog.validate.htmlLength(f.invalidHtmlLength.replace('%1',
