...
(function () {
  ...
  // parser fixing.
  var nonBreakingBlocks = CKEDITOR.tools.extend({ table:1, ul:1, ol:1, dl:1 }, CKEDITOR.dtd.table, CKEDITOR.dtd.ul,
    CKEDITOR.dtd.ol, CKEDITOR.dtd.dl);
  ...
  CKEDITOR.htmlParser.fragment.fromHtml = function (fragmentHtml, fixForBody, contextNode) {
    var parser = new CKEDITOR.htmlParser(), fragment = contextNode || new CKEDITOR.htmlParser.fragment(), pendingInline = [], pendingBRs = [], currentNode = fragment, // Indicate we're inside a <textarea> element, spaces should be touched differently.
        ...
        if (!element.isUnknown && !currentNode.isUnknown && !currentDtd[ tagName ]) {
          ...
          // Fixing malformed nested lists by moving it into a previous list item. (#3828)
            ...
            // Establish new list root for orphan list items.
              ...
              if (tagName in CKEDITOR.dtd.$listItem && currentName != tagName) {
