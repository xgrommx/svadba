...
(function () {
  ...
  var onConfigLoaded = function (editor) {
    ...
    var skin = editor.config.skin.split(','), skinName = skin[ 0 ], skinPath = CKEDITOR.getUrl(skin[ 1 ] || (
  ...
  var loadPlugins = function (editor) {
    var config = editor.config, plugins = config.plugins, extraPlugins = config.extraPlugins, removePlugins = config.removePlugins;
    ...
    CKEDITOR.plugins.load(plugins.split(','), function (plugins) {
      ...
      for (var pluginName in plugins) {
        var plugin = plugins[ pluginName ], pluginLangs = plugin.lang, pluginPath = CKEDITOR.plugins.getPath(pluginName), lang = null;
  ...
  function updateCommands() {
    var command, commands = this._.commands, mode = this.mode;
