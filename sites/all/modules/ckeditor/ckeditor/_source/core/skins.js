...
CKEDITOR.skins = (function () {
  ...
  var loadPart = function (editor, skinName, part, callback) {
    ...
    if (partIsLoaded) {
      ...
      // for that part.
      var cssIsLoaded = !part.css || !part.css.length, jsIsLoaded = !part.js || !part.js.length;
  ...
  return /** @lends CKEDITOR.skins */ {
    ...
    add:function (skinName, skinDefinition) {
      ...
      skinDefinition.skinPath = paths[ skinName ] || ( paths[ skinName ] = CKEDITOR.getUrl('_source/' + // @Packager.RemoveLine
                                                                                           'skins/' + skinName + '/') );
    },
    ...
    load:function (editor, skinPart, callback) {
      var skinName = editor.skinName, skinPath = editor.skinPath;
