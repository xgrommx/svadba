  ...
  commands:{
    removeformat:{
      exec:function (editor) {
        var tagsRegex = editor._.removeFormatRegex || ( editor._.removeFormatRegex = new RegExp('^(?:' + editor.config.removeFormatTags.replace(/,/g,
          '|') + ')$', 'i') );
        ...
        while (( range = iterator.getNextRange() )) {
          ...
          var bookmark = range.createBookmark(), // The style will be applied within the bookmark boundaries.
            startNode = bookmark.startNode, endNode = bookmark.endNode, currentNode;
          ...
          var breakParent = function (node) {
            ...
            var path = new CKEDITOR.dom.elementPath(node), pathElements = path.elements;
          ...
          if (endNode) {
            ...
            while (currentNode) {
              ...
              if (!( currentNode.getName() == 'img' && currentNode.data('cke-realelement') ) && filter(editor,
                currentNode)) {
