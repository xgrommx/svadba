...
(function () {
  var cssTemplate = '.%2 p,' + '.%2 div,' + '.%2 pre,' + '.%2 address,' + '.%2 blockquote,' + '.%2 h1,' + '.%2 h2,' + '.%2 h3,' + '.%2 h4,' + '.%2 h5,' + '.%2 h6' + '{' + 'background-repeat: no-repeat;' + 'background-position: top %3;' + 'border: 1px dotted gray;' + 'padding-top: 8px;' + 'padding-%3: 8px;' + '}' +
                    ...
                    '.%2 address' + '{' + '%1address.png);' + '}' +

                    '.%2 blockquote' + '{' + '%1blockquote.png);' + '}' +
  ...
  CKEDITOR.plugins.add('showblocks', {
      ...
      init:function (editor) {
        ...
        editor.addCss(cssTemplate.replace(cssTemplateRegex,
          'background-image: url(' + CKEDITOR.getUrl(this.path) + 'images/block_').replace(cssClassRegex,
          'cke_show_blocks ').replace(backgroundPositionRegex, editor.lang.dir == 'rtl' ? 'right' : 'left'));
