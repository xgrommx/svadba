...
CKEDITOR.dialog.add('uicolor', function (editor) {
  var dialog, picker, pickerContents, // Actual UI color value.
    uiColor = editor.getUiColor(), pickerId = 'cke_uicolor_picker' + CKEDITOR.tools.getNextNumber();
            ...
            children:[
              {
                ...
                onChange:function () {
                  ...
                  var on = this.getValue(), color = on ? '#' + picker.get('hex') : uiColor;
