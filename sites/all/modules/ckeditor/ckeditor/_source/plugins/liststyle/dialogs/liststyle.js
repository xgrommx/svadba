  ...
  function listStyle(editor, startupPage) {
    ...
    if (startupPage == 'bulletedListStyle') {
      return {
        ...
        onShow:function () {
          var editor = this.getParentEditor(), element = getListElement(editor, 'ul');
      ...
      if (startupPage == 'numberedListStyle') {
        ...
        return {
          ...
          onShow:function () {
            var editor = this.getParentEditor(), element = getListElement(editor, 'ol');
