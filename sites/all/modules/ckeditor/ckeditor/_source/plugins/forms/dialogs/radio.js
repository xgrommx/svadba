...
CKEDITOR.dialog.add('radio', function (editor) {
  return {
    ...
    onOk:function () {
      var editor, element = this.radioButton, isInsertMode = !element;
            ...
            commit:function (data) {
              ...
              if (!( CKEDITOR.env.ie || CKEDITOR.env.opera )) {
                ...
                if (isElementChecked != isChecked) {
                  var replace = CKEDITOR.dom.element.createFromHtml('<input type="radio"' + ( isChecked ? ' checked="checked"' : '' ) + '></input>',
                    editor.document);
