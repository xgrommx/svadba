...
CKEDITOR.dialog.add('colordialog', function (editor) {
    ...
    var $el = CKEDITOR.dom.element, $doc = CKEDITOR.document, $tools = CKEDITOR.tools, lang = editor.lang.colordialog;
    ...
    function updateSelected(evt) {
      ...
      var target = evt.getTarget(), color;
    ...
    function updateHighlight(event) {
      ...
      var target = event.getTarget(), color;
    ...
    var onMouseout = $tools.addFunction(clearHighlight), onClick = updateSelected, onClickHandler = CKEDITOR.tools.addFunction(onClick), onFocus = updateHighlight, onBlur = clearHighlight;
    ...
    }, hicolorId = numbering('hicolor'), hicolorTextId = numbering('hicolortext'), selHiColorId = numbering('selhicolor'), tableLabelId = numbering('color_table_label');
          ...
          elements:[
            {
              ...
              children:[
                {
                  type:'html',
                  html:'<table role="listbox" aria-labelledby="' + tableLabelId + '" onmouseout="CKEDITOR.tools.callFunction( ' + onMouseout + ' );">' + ( !CKEDITOR.env.webkit ? html : '' ) + '</table><span id="' + tableLabelId + '" class="cke_voice_label">' + lang.options + '</span>',
                  onLoad:function () {
