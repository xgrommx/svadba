            ...
            addTarget:function (element, nativeContextMenuOnCtrl) {
              ...
              if (CKEDITOR.env.opera && !( 'oncontextmenu' in document.body )) {
                ...
                element.on('mousedown', function (evt) {
                  ...
                  contextMenuOverrideButton.setAttribute('style',
                    'position:absolute;top:' + ( evt.$.clientY - 2 ) + 'px;left:' + ( evt.$.clientX - 2 ) + 'px;width:5px;height:5px;opacity:0.01');
              ...
              element.on('contextmenu', function (event) {
                ...
                if (nativeContextMenuOnCtrl && // Safari on Windows always show 'ctrlKey' as true in 'contextmenu' event,
                  ...
                  var offsetParent = domEvent.getTarget().getDocument().getDocumentElement(), offsetX = domEvent.$.clientX, offsetY = domEvent.$.clientY;
