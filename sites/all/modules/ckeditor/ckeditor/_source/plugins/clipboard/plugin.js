...
(function () {
  ...
  var execIECommand = function (editor, command) {
    var doc = editor.document, body = doc.getBody();
  ...
  var tryToCutCopy = CKEDITOR.env.ie ? function (editor, type) {
  ...
  var pasteCmd = {
    ...
    exec:CKEDITOR.env.ie ? function (editor) {
  ...
  function getClipboardData(evt, mode, callback) {
    ...
    var sel = this.getSelection(), range = new CKEDITOR.dom.range(doc);
