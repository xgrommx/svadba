...
(function () {
  ...
  CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
      $:function (editor, parentElement, definition, level) {
        ...
        var doc = parentElement.getDocument(), panel = getPanel(editor, doc, parentElement, definition,
          level || 0), element = panel.element, iframe = element.getFirst().getFirst();
      ...
      proto:{
        ...
        showBlock:function (name, offsetParent, corner, offsetX, offsetY) {
          var panel = this._.panel, block = panel.showBlock(name);
          ...
          var element = this.element, iframe = this._.iframe, definition = this._.definition, position = offsetParent.getDocumentPosition(element.getDocument()), rtl = this._.dir == 'rtl';

          var left = position.x + ( offsetX || 0 ), top = position.y + ( offsetY || 0 );
          ...
          CKEDITOR.tools.setTimeout(function () {
            ...
            var panelLoad = CKEDITOR.tools.bind(function () {
              ...
              var panelElement = panel.element, panelWindow = panelElement.getWindow(), windowScroll = panelWindow.getScrollPosition(), viewportSize = panelWindow.getViewPaneSize(), panelSize = {
              ...
              if (CKEDITOR.env.ie) {
                var offsetParent = new CKEDITOR.dom.element(element.$.offsetParent), scrollParent = offsetParent;
