...
(function () {
  ...
  var beginWhitespaceRegex = /^[\r\n\t ]+$/, // Ignore bookmark nodes.(#3783)
    bookmarkGuard = CKEDITOR.dom.walker.bookmark(false,
      true), whitespacesGuard = CKEDITOR.dom.walker.whitespaces(true), skipGuard = function (node) {
  ...
  iterator.prototype = {
    getNextParagraph:function (blockTag) {
      ...
      if (!this._.lastNode) {
        ...
        var walker = new CKEDITOR.dom.walker(range), ignoreBookmarkTextEvaluator = CKEDITOR.dom.walker.bookmark(true, true);
      ...
      while (currentNode) {
        ...
        var closeRange = 0, parentPre = currentNode.hasAscendant('pre');
          ...
          if (!block || ( this.enforceRealBlocks && block.getName() == 'li' )) {
            ...
            if (block.getName() != 'li') {
              ...
              if (!isLast) {
                ...
                this._.nextNode = ( block.equals(lastNode) ? null : getNextSourceNode(range.getBoundaryNodes().endNode, 1,
                  lastNode) );
              }
            }
          }
