  ...
  Drupal.behaviors.devel_explain = {
    attach:function () {
      $('a.dev-explain').click(function () {
        ...
        $('.dev-explain',
          cell).load(Drupal.settings.basePath + '?q=devel/explain/' + Drupal.settings.devel.request_id + '/' + qid).show();
  ...
  Drupal.behaviors.devel_arguments = {
    attach:function () {
      $('a.dev-arguments').click(function () {
        ...
        cell = $('#devel-query-' + qid);
        $('.dev-arguments',
          cell).load(Drupal.settings.basePath + '?q=devel/arguments/' + Drupal.settings.devel.request_id + '/' + qid).show();
        $('.dev-placeholders', cell).hide();
