...
(function ($) {
  Drupal.behaviors.CToolsDropbutton = {
    attach:function () {
      ...
      $('.ctools-button:not(.ctools-button-processed)').removeClass('ctools-no-js').addClass('ctools-button-processed');
      // Process dropbuttons. Not all buttons are dropbuttons.
      $('.ctools-dropbutton:not(.ctools-dropbutton-processed)').addClass('ctools-dropbutton-processed').each(function () {
          var $dropbutton = $(this);
