...
(function ($) {
        ...
        var setChangeTrigger = function (trigger_id, bind_id) {
          ...
          var changeTrigger = function () {
            ...
            for (i in Drupal.CTools.dependent.bindings[bind_id]) {
              ...
              if (val != null && Drupal.CTools.dependent.inArray(Drupal.settings.CTools.dependent[id].values[bind_id],
                val)) {
  ...
  Drupal.behaviors.CToolsDependent = {
    attach:function (context) {
      ...
      $("select.ctools-master-dependent:not(.ctools-processed)").addClass('ctools-processed').change(function () {
          var val = $(this).val();
          if (val == 'all') {
