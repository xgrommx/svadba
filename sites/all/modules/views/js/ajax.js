...
(function ($) {
  ...
  Drupal.behaviors.syncPreviewDisplay = {
    attach:function (context) {
      $("#views-tabset a").once('views-ajax-processed').click(
        function () {
  ...
  Drupal.behaviors.viewsAjax = {
    ...
    attach:function (context, settings) {
      ...
      $('div#views-live-preview a').once('views-ajax-processed').each(function () {
      ...
      $('div#views-live-preview input[type=submit]').once('views-ajax-processed').each(function (event) {
          $(this).click(function () {
            this.form.clk = this;
            return true;
          });
