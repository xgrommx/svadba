...
class ViewsUiBaseViewsWizard implements ViewsWizardInterface {
  ...
  function build_form($form, &$form_state) {
    ...
    $style_form['style_plugin']['#default_value'] = views_ui_get_selected($form_state,
      array('page', 'style', 'style_plugin'), 'default', $style_form['style_plugin']);
    ...
    $style_form['style_plugin']['#default_value'] = views_ui_get_selected($form_state,
      array('block', 'style', 'style_plugin'), 'default', $style_form['style_plugin']);
  ...
  protected function build_form_style(&$form, &$form_state, $type) {
    ...
    if (isset($style_plugin) && $style_plugin->uses_row_plugin()) {
      ...
      $style_form['row_plugin']['#default_value'] = views_ui_get_selected($form_state, array($type, 'style', 'row_plugin'),
