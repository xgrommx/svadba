...
class panels_renderer_ipe extends panels_renderer_editor {
  ...
  function render_pane(&$pane) {
    ...
    $output = theme('panels_ipe_pane_wrapper',
      array('output' => $output, 'pane' => $pane, 'display' => $this->display, 'renderer' => $this));
  ...
  function render_region($region_id, $panes) {
    ...
    $empty_ph = theme('panels_ipe_placeholder_pane',
      array('region_id' => $region_id, 'region_title' => $this->plugins['layout']['regions'][$region_id]));
    ...
    $panes['add_button'] = theme('panels_ipe_add_pane_button',
      array('region_id' => $region_id, 'display' => $this->display, 'renderer' => $this));

    $output = parent::render_region($region_id, $panes);
    $output = theme('panels_ipe_region_wrapper',
      array('output' => $output, 'region_id' => $region_id, 'display' => $this->display, 'renderer' => $this));
  ...
  function command_add_pane($pid) {
    ...
    $this->commands[] = ajax_command_append("#panels-ipe-regionid-$region_id div.panels-ipe-sort-container",
      $this->render_pane($pane));
    $this->commands[] = ajax_command_changed("#panels-ipe-display-{$this->clean_key}");
  }
}
