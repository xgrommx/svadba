  ...
  if (in_array($vars['elements']['#region'], array('content', 'menu', 'branding'))) {
    ...
    switch ($vars['elements']['#region']) {
      ...
      case 'branding':
        ...
        $vars['linked_site_name'] = l($vars['site_name'], '<front>',
          array('attributes' => array('rel' => 'home', 'title' => t('Home')), 'html' => TRUE));
        ...
        $vars['linked_logo_img'] = $vars['logo'] ? l($vars['logo_img'], '<front>',
          array('attributes' => array('rel' => 'home', 'title' => t($vars['site_name'])), 'html' => TRUE)) : '';
        break;
    }
  }
}
